define("arale/validator/0.9.7/validator-debug", [ "./core-debug", "$", "./async-debug", "widget", "base", "class", "events", "./utils-debug", "./rule-debug", "./item-debug" ], function(require, exports, module) {
...
define("arale/validator/0.9.7/core-debug", [ "$", "./async-debug", "widget", "base", "class", "events", "./utils-debug", "./rule-debug", "./item-debug" ], function(require, exports, module) {
    var $ = require("$"), 
...
define("arale/validator/0.9.7/utils-debug", [ "$", "./rule-debug" ], function(require, exports, module) {
    var $ = require("$"), 
...
define("arale/validator/0.9.7/item-debug", [ "$", "./utils-debug", "./rule-debug", "widget", "base", "class", "events", "./async-debug" ], function(require, exports, module) {
    var $ = require("$"), 
        utils = require("./utils-debug"), 
        Widget = require("widget"), 
        async = require("./async-debug"), 
