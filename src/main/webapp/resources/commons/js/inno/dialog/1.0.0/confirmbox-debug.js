define("inno/dialog/1.0.0/confirmbox-debug",["$","./dialog-debug","./confirmbox-debug.handlebars"],function(require,exports,module){
    ...
    var ConfirmBox = Dialog.extend({
        ...
        switchIcon:function(){
            ...
            switch(index){
                case 1:
                    str="<i class='iconfont' style='color:#ff9524;font-size:40px;margin-right:10px;'>&#xf009d;</i>";
                    break;
                case 2:
                    str="<i class='iconfont' style='color:#e03d3e;font-size:40px;margin-right:10px;'>&#xf0098;</i>";
                    break;
                case 3:
                    str="<i class='iconfont' style='color:#2bb410;font-size:40px;margin-right:10px;'>&#xf007b;</i>";
                    break;
                case 4:
                    str="<i class='iconfont' style='color:#666666;font-size:40px;margin-right:10px;'>&#xf005a;</i>";
                    break;
                default:
                    str="";
            }
...
define("inno/dialog/1.0.0/dialog-debug",["$","dialog","./dialog-debug.handlebars","./dialog-debug.css"],function(require,exports,module){
	...
	var Dialog=AraleDialog.extend({
        ...
        parseElement:function(){
            ...
            // 必要的样式
            var height = parseInt(this.get("height")) -30; 
...
define("inno/dialog/1.0.0/dialog-debug.handlebars", [ "handlebars-runtime" ], function(require, exports, module) {
    ...
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        buffer += escapeExpression(stack1) + '-close iconfont" title="关闭本框" href="javascript:;" data-role="close"></a>\n </div>\n   <div class="';
        if (stack1 = helpers.classPrefix) {
            stack1 = stack1.call(depth0, {
                hash: {},
                data: data
