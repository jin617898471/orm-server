	...
	var Tabs=AraleTabs.extend({
        	...
        	setup: function () {
                if(this.get("closeStatus")){
                    this.get("triggers").append("<a class='iconfont ui-tabs-trigger-close' data-role='close'>&#xf0098;</a>");
                }
            ...
            addPanel:function(triggerName,panelContent,closeStatus,closeId){
                var nav= this.nav,
                    ...
                    that=this;
                if(closeStatus){
                    triggerName += "<a class='iconfont ui-tabs-trigger-close' data-role='close' id='"+ closeId +"'>&#xf0098;</a>";
                }
