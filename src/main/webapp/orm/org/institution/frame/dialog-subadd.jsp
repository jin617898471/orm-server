...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>orm/org/institution/css/dialog-subadd.css" />
</head>
<body>
		...
		<form id="orgForm">
			<ul>
				...
				<li class="subadd-items">
					<label class="subadd-items-label">机构简称：</label>
					<input type="text" class="subadd-items-inp" name="orgNameShort" value="${org.orgNameShort}"/>
				</li>
				<li class="subadd-items subadd-items-required">
				...
				<li class="subadd-items">
					<label class="subadd-items-label">所属地域：</label>
					<input type="text" class="subadd-items-inp" name="orgArea" value="${org.orgArea}"/>
				</li>
				<li class="subadd-items">
				...
				<li class="subadd-items">
					<label class="subadd-items-label">机构网站：</label>
					<input type="text" class="subadd-items-inp" name="orgWeburl" value="${org.orgWeburl}"/>
				</li>
				<li class="subadd-items fullw">
					<label class="subadd-items-label">机构邮编：</label>
					<input type="text" class="subadd-items-inp" name="orgPostcode" value="${org.orgPostcode}"/>
				</li>
				<li class="subadd-items fullw">
					<label class="subadd-items-label">机构地址：</label>
					<input type="text" class="subadd-items-inp inp-address" name="orgAddress" value="${org.orgAddress}"/>
				</li>
			</ul>
    ...
    <script>
    	seajs.use("<%=basePath%>orm/org/institution/js/dialog-subadd.js");
    </script>
