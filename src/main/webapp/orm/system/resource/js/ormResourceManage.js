define(function(require){
    ...
    function zTreeBeforeClick(treeId, treeNode, clickFlag) {
    	...
    	var QUERYCONDITION= '{"rules":[{"field":"presId","op":"like","value":"'+presId+'"}],"groups":[],"op":"and"}';
	...
	function inittableUtil(treeObj,flag){
	    ...
	    var QUERYCONDITION= '{"rules":[{"field":"presId","op":"equal","value":"'+id+'"},{"field":"resourceId","op":"notequal","value":"'+id+'"}],"groups":[],"op":"and"}';
	...
	function getGridColumns() {
		return [[ 
			     { field : 'resourceName', title : '资源名称', width : 140, align : 'left', sortable : true }, 
			     { field : 'resourceUrl', title : 'URL', width :140, align : 'left', sortable : true },
			     { field : 'resourceType', title : '类型', width : 80, align : 'left', sortable : true ,formatter : formatterTypeByResource},  
			     { field : 'systemId', title : '所属系统', width : 100, align : 'left', sortable : true ,formatter : formatterSysByResource}, 
	...
	function getGridOperation(value, rec, index) {
		var v = '<a href="javascript:void(0)" onclick="tableRowDetailsSee(\'' + rec.resourceId + '\' )" >查看</a> ';
		var e = '<a href="javascript:void(0)" onclick="tableRowDetailsEdit(\'' + rec.resourceId + '\')" >编辑</a> ';
		var p = '<a href="javascript:void(0)" onclick="tableRowDetailsDelete(\'' + rec.resourceId + '\')" >删除</a> ';
		return v + e + p;
	}
	...
	tableRefresh = function(pid,id,name,type,system,resourceType){
    	...
    	if (pnodes.length>0) {
    		if(type==1){
    			snodes = {id:id,name:name,system:system,resourceType:resourceType};
