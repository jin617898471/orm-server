		...
		<div class="ui-form-container">
			<div class="ui-form-2item">
				...
				<div class="ui-form-item-col">
					...
					<input class="ui-input ui-input-w190" id = "userAcctPwd" name="userAcctPwd" type = "password" value="${OrmUser.userAcctPwd}" >
					<span class="ui-form-required">*</span>
					<div class="ui-form-explain"></div>
				</div>
				<div class="ui-form-item-col">
					<label class="ui-label">重复登录密码:</label>
					<input class="ui-input ui-input-w190"  type = "password"  name ="password-confirmation" value="${OrmUser.userAcctPwd}">
					<span class="ui-form-required">*</span>
					<div class="ui-form-explain"></div>
				</div>
				<div class="ui-form-item-have2col" style = "display:none">
					...
					<div class="ui-select-trigger  oserial"   style="width: 358px">
				        <span data-role="trigger-content"></span>        
				       	...
				       	<input class="ui-input ui-input-w190"  name = "oserial" type = "hidden" value = "${OrmUser.oserial}" />
				    </div>
					<span class="ui-form-required">*</span>
					<div class="ui-form-explain"></div>
				</div>
		...
		<div class="ui-form-container">
			<div class="ui-form-2item">
				...
				<div class="ui-form-item-have2col">
					<label class="ui-label">用户账号描述:</label>
					<div class="ui-textarea-container">
						<div class="ui-textarea-border" style="width:92.5%;height:80px;">
							<textarea class="ui-textarea" name="userAcctDesc" >${OrmUser.userAcctDesc}</textarea>
						</div>
					</div>
				</div>
				<div class="ui-form-item-have2col" style = "display:none">
...
<script type="text/javascript">
	seajs.use( "<%=basePath%>orm/organization/ormuser/js/ormUserEdit" );
</script>
</html>