...
public interface OrmUserRoleMapDao extends BaseDao<OrmUserRoleMap, String> {
	...
	public Long deleteByUserIdAndRoleIdAndMapType(String userId, String roleId,String mapType);
	...
	@Query("select m.mapType,o from OrmUserRoleMap m,OrmRole o where m.roleId = o.roleId and m.userId=?1")
