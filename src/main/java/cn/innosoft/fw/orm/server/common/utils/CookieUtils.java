...
public class CookieUtils {
	 ...
	 * @return
	 */
	public static Cookie addCookieInRoot(HttpServletRequest request, HttpServletResponse response, String name,
	 ...
	 * @param domain
	 */
	public static void cancleCookieInRoot(HttpServletRequest request, HttpServletResponse response, String name,
			String domain) {
